...
const {	mySendAndConfirmTransaction } = require('./utils');


const createPool = async (connection, payer, baseMint, baseTokenAmount, omaxAmount) => {
	...
	// const quoteAmount = omaxAmount// * BigInt(10 ** quoteToken.decimals);
